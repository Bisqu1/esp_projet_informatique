...
class Interface(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.create_image()
        #apelle la fonction pour remplacer l'image
        self.update()
